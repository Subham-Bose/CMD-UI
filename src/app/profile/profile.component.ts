...
export class ProfileComponent implements OnInit {
    ...
    constructor(private formBuilder: FormBuilder,
        private service: DoctorFieldService, public doctorservice: DoctorFieldService) { }
    ...
    ngOnInit(): void {
        ...
        this.service.getDoctorprofile(2).subscribe({
            next: (d) => {
                this.doctor = d;
            },
            complete: () => {
    ...
    OnClick2() {
        this.editable = !this.editable;
        var data = new Doctor(this.doctorform.get("id").value,
            ...
            new Contact(this.doctorform.get("Id").value,
